  ...
  return (
    <div className="min-h-screen grid w-full items-center bg-zinc-100 px-4 font-mono text-sm">
      <SignIn.Root>
        <SignIn.Step
          name="start"
          className="mx-auto w-full sm:w-96 space-y-6 bg-white px-4 py-8 border-4 border-black 
        ...
        >
          ...
          <Clerk.Connection
            name="google"
            className="flex w-full items-center justify-center gap-3 px-4 py-2 bg-yellow-400 border-2 border-black 
            shadow-[4px_4px_0_0_#000] active:translate-y-0.5 active:shadow-none font-bold"
          >
          ...
          <p className="text-center text-xs text-black">
            ...
            <Clerk.Link
              navigate="sign-up"
              className="font-bold underline underline-offset-2 hover:text-yellow-600 ml-1"
            >
              Create an account
            </Clerk.Link>
          </p>
