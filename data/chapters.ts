export const chapstersData = [
  ...
  },
  {
    id: 3,
    name: "Head & Body Tags",
    desc: "Learn the difference between behind-\nthe-scenes metadata and visible page content.",
    exercises: [
      {
        name: "Mind vs Body",
        slug: "mind-vs-body",
  ...
  },
  {
    ...
    desc: "Format your content with headings,\nparagraphs, bold, italic, and more.",
    exercises: [
      {
  ...
  },
  {
    ...
    desc: "Create portals between pages and\nbuild simple navigation.",
    exercises: [
      {
  ...
  },
  {
    id: 6,
    name: "Images",
    desc: "Display images, control sizing, and\noptimize accessibility.",
    exercises: [
      {
