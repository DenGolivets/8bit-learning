export const courses = [
  ...
  },
  {
    ...
    desc: "Master advanced Python concepts such as OOP, modules, APIs, datra processing, and automation.",
    path: "/course/6/detail",
  },
  {
    id: 7,
    name: "Generative AI",
    desc: "Explore prompt engineering, LLMS, embeddings, iamge generation, and build GenAI-powered applications.",
  ...
  },
  {
    id: 9,
    name: "Javascript",
    desc: "Learn core JavaScript concepts, asynchronous programming, DOM manipulation, and modern web ES6+ features.",
